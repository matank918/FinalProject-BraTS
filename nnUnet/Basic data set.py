...
class BasicDataset(Dataset):
    ...
    def get_folder_names(self):
        ...
        """
        self.folder_names = [os.path.join(self.dir, dI) for dI in os.listdir(self.dir) if os.path.isdir(os.path.join(self.dir, dI))]
    ...
    def __len__(self):
        """
                               ...
                               :return (int):
                               check the length of the list "folder_names"
                """
    ...
    def show_image(self, i):
        """
                   ...
                   1. load image
                   2. create a subplot
                   3. display the differ angles of each image
                   """
        file_dir = self.folder_names[i]
        files_list = [os.path.join(file_dir, dI) for dI in os.listdir(file_dir)]
        for file in files_list:
